...
private:
	...
	/** Helper: Draw trajectory samples */
	void DrawTrajectorySamples(const TArray<FTrajectorySamplePoint>& Samples, FColor Color);
...
UAsyncQueryExampleActor::UAsyncQueryExampleActor()
{
...
void UAsyncQueryExampleActor::Example1_BasicAsyncQuery()
{
...
void UAsyncQueryExampleActor::Example2_DualRadiusQuery()
{
...
void UAsyncQueryExampleActor::Example3_TimeRangeQuery()
{
...
void UAsyncQueryExampleActor::Example4_QueryTrajectoryInteraction()
{
...
void UAsyncQueryExampleActor::Example5_SequentialQueries()
{
...
void UAsyncQueryExampleActor::Example6_VisualizeResults()
{
	...
	TWeakObjectPtr<UAsyncQueryExampleActor> WeakThis(this);
	...
	Manager->QueryRadiusWithDistanceCheckAsync(
		...
		FOnSpatialHashQueryComplete::CreateLambda([WeakThis, QueryPosition, Radius](const TArray<FSpatialHashQueryResult>& Results)
		{
			...
			UAsyncQueryExampleActor* This = WeakThis.Get();
...
void UAsyncQueryExampleActor::Example7_ErrorHandling()
{
...
void UAsyncQueryExampleActor::Example8_MemberCallbacks()
{
	...
	Manager->QueryRadiusWithDistanceCheckAsync(
		...
		10.0f,
		100,
		FOnSpatialHashQueryComplete::CreateUObject(this, &UAsyncQueryExampleActor::OnQueryComplete_MemberFunction)
	);
	
	UE_LOG(LogTemp, Log, TEXT("Member callback query started..."));
}

void UAsyncQueryExampleActor::OnQueryComplete_MemberFunction(const TArray<FSpatialHashQueryResult>& Results)
{
...
void UAsyncQueryExampleActor::PrintQueryStats(const TArray<FSpatialHashQueryResult>& Results, const FString& QueryName)
{
